...
def main(args):
    ...
    gt_path = "./data/DALI/info/gt_v1.0_22:11:18.gz"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--workspace", type=str, default="./workspaces/", help="Directory of workspace.")
    parser.add_argument("--dataset_dir", type=str, default="./data/DALI", help="Directory of DALI dataset.")
    parser.add_argument("--config_yaml", type=str, default="./datapreprocess/configs/DALI/create_indexes.yaml", help="Path to configs.")
